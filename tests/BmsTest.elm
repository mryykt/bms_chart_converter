...
import Bms.Save exposing (toRawData, toString)
import Dict
import Expect
...
bmsTest =
    ...
    describe "rawBms test"
        ...
        , test "save bms" <|
            \_ -> Expect.equal (toString testBms) <| """; This chart is generated by bms-chart-converter(https://github.com/mryykt/bms_chart_converter).
